...
export const MOCK_PAGES: PageSummary[] = [
   ...
   */
  {
    id: "weekly-shop",
    type: "checklist",
    checklist: { purpose: "shopping", scope: "household", listType: "weekly" },
    spaceId: "home",
    status: "active",
    title: "Weekly Shop",
  ...
  },
  {
    ...
    type: "checklist",
    checklist: { purpose: "shopping", scope: "household", listType: "reusable" },
    spaceId: "home",
    status: "active",
    title: "Cleaning Supplies",
    description: "The same eight things, bought again whenever they run out.",
    lastUpdatedAt: daysAgo(9, 11),
    favorite: false,
    visibility: "private",
  },
  {
